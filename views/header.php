...
<html lang="en" dir="ltr">
    <head>
        ...
        <title>Gobierno Autónomo Municipal de la Ciudad de Tarija y la Provincia Cercado - Tramitar v2.0</title>
        ...
        <script defer src="../public/assets/js/sweetalert.min.js"></script>
        <link rel="stylesheet" type="text/css" href="../public/assets/css/nice-select2.css" />
        <style type="text/css">
            .mayusculas{
                    ...
                    <div class="h-full bg-white dark:bg-[#0e1726]">
                        <div class="flex items-center justify-between px-4 py-3">
                            <a href="index.html" class="main-logo flex shrink-0 items-center">
                                <img class="ml-[5px] w-8 flex-none" src="../public/assets/images/logo.svg" alt="image" />
                    ...
                    <div class="shadow-sm">
                        <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                                <a href="index.html" class="main-logo flex shrink-0 items-center">
                                    <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="../public/assets/images/logo.svg" alt="image" />
                                    <span
                            ...
                            >
                                ...
                                <div class="dropdown shrink-0" x-data="dropdown" @click.outside="open = false">
                                    ...
                                    >
                                        <img
                                            :src="`../public/assets/images/flags/${$store.app.locale.toUpperCase()}.svg`"
                                            alt="image"
                                        ...
                                        <template x-for="item in languages">
                                            <li>
                                                ...
                                                >
                                                    <img
                                                        class="h-5 w-5 rounded-full object-cover"
                                                        :src="`../public/assets/images/flags/${item.value.toUpperCase()}.svg`"
                                                        alt="image"
                                                    />
                                    ...
                                    <a href="javascript:;" class="group relative" @click="toggle()">
                                        <span
                                            ><img
                                                ...
                                                src="../public/assets/images/user-profile.jpeg"
                                                alt="image"
                                        /></span>
                                    </a>
                                    <ul
                                    ...
                                    >
                                        <li>
                                            <div class="flex items-center px-4 py-4">
                                                <div class="flex-none">
                                                    <img class="h-10 w-10 rounded-md object-cover" src="../public/assets/images/user-profile.jpeg" alt="image" />
                                                </div>
