...
<div x-data="striped" id="striped">
    <div class="panel mt-6" id="listadoregistros">
        <div class="hover md:absolute md:top-[25px] md:mb-0 flex flex-wrap items-center left-between gap-4">
            <h5 class="font-semibold text-lg dark:text-white-light">Tipos de Hojas de Ruta</h5>
                    ...
                    <div class="flex">
                        <div class="bg-[#eee] flex justify-center items-center ltr:rounded-l-md rtl:rounded-r-md px-3 font-semibold border ltr:border-r-0 rtl:border-l-0 border-[#e0e6ed] dark:border-[#17263c] dark:bg-[#1b2e4b]">
                            <label class="w-7 h-4 relative cursor-pointer mb-0">
                                <input type="checkbox" class="peer absolute w-full h-full opacity-0 z-10 focus:ring-0 focus:outline-none cursor-pointer" id="importante" name="importante" />
                        ...
                        <input id="tiempo_total" name="tiempo_total" value="0" type="number" placeholder="Tiempo de Atención Total (En horas)" value="0" class="form-input ltr:rounded-l-none rtl:rounded-r-none" />
                    </div>
                </div>                    
            </div>
...
<?php
    require 'footer.php';
?>       
<script type="text/javascript" src="js/tipo_tramite.js"></script>              